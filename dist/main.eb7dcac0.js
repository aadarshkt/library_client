...
})(
  {
    epB2: [
      function (require, module, exports) {
        ...
        var o = fetch("https://library-server-3i6d.onrender.com/8080/api/books"),
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            (t.prev = 0),
                            (t.next = 3),
                            fetch("https://library-server-3i6d.onrender.com/8080/api/books?id=".concat(r), {
                              method: "DELETE",
                            })
                          );
                        case 3:
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            ...
                            (t.prev = 2),
                            (t.next = 5),
                            fetch("https://library-server-3i6d.onrender.com/8080/api/books?id=".concat(n), {
                              method: "PUT",
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            ...
                            (t.prev = 2),
                            (t.next = 5),
                            fetch("https://library-server-3i6d.onrender.com/8080/api/books", {
                              method: "POST",
                              headers: { "Content-Type": "application/json" },
...
//# sourceMappingURL=/main.eb7dcac0.js.map
