...
})(
  {
    epB2: [
      function (require, module, exports) {
        ...
        var o = fetch("http://localhost:8080/api/books"),
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            (t.prev = 0),
                            (t.next = 3),
                            fetch("http://localhost:8080/api/books?id=".concat(r), { method: "DELETE" })
                          );
                        case 3:
                          if ((n = t.sent).ok) {
                            t.next = 6;
                        ...
                        case 9:
                          (t.t1 = t.sent), t.t0.log.call(t.t0, "Book deleted successfully", t.t1), (t.next = 17);
                          break;
                        case 13:
                          (t.prev = 13), (t.t2 = t.catch(0)), alert("Database hosting is costly"), console.error(t.t2);
                        case 17:
                        case "end":
                          return t.stop();
                      }
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            ...
                            (t.prev = 2),
                            (t.next = 5),
                            fetch("http://localhost:8080/api/books?id=".concat(n), {
                              method: "PUT",
                        ...
                        case 11:
                          (t.t1 = t.sent), t.t0.log.call(t.t0, "Book updated successfully", t.t1), (t.next = 19);
                          break;
                        case 15:
                          (t.prev = 15), (t.t2 = t.catch(2)), alert("Database hosting is costly"), console.error(t.t2);
                        case 19:
                        case "end":
                          return t.stop();
                      }
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 12:
                          ...
                          break;
                        case 14:
                          (t.prev = 14), (t.t0 = t.catch(2)), alert("Database hosting is costly"), console.error(t.t0);
                        case 18:
                        case "end":
                          return t.stop();
                      }
...
//# sourceMappingURL=/main.33b7f344.js.map
